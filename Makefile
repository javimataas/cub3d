...
#    Updated: 2024/01/30 18:47:52 by jmatas-p         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		=	src/main.c \
			...
			src/render/map/map.c src/hooks/hooks.c src/hooks/move_hooks.c src/hooks/hooks_utils.c src/rays/pov.c \
			src/rays/c_pixel.c src/rays/rays.c src/rays/rays_utils.c src/render/minimap/player.c \
